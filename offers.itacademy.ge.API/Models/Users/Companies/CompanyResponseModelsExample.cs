...
{
    public class CompanyResponseModelsExample : IExamplesProvider<List<CompanyResponseModel>>
    {
        public List<CompanyResponseModel> GetExamples()
        {
            return new List<CompanyResponseModel>
            {
